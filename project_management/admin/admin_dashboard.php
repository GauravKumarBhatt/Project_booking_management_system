        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form action="" method="post">
                    <a class="btn btn-primary" href="project.php">Book Project</a>
                    <a class="btn btn-success" href="project.php">Check Project Status</a>
        ...
        <div class="row">
        	<div class="col-md-12">
        		...
        		<?php 
                    ...
                    $query = "select * from mini_project where status = 1;";
